# BidURS.in - Live E-Auction Platform (Frontend Demo)

## Overview
BidURS.in is a premium, product-based live e-auction platform. This project is a **Frontend-Only Prototype** designed to demonstrate the user interface, design system, and user flows of the application. 
